 ...
 **/
 ...
 class RequestForQoutationMaterial_model extends CI_Model
 {
	var $t_table 	= 'request_for_qoutation_material';
	...
	public function get_where_many($search = [])
	{
		...
		$this->db->join('material', 'material.id = request_for_qoutation_material.material_id', 'left');
		$i = $this->db->get();
