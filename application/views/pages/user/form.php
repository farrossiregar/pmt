    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <form id="demo-form2" method="post" class="form-horizontal form-label-left">
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="username">Region </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <select class="form-control" name="User[branch_id]">
                <option value=""> - Select - </option>
              <?php 
                $i = $this->db->get('region');
                ...
                foreach($i->result_array() as $i) {
                  ...
                  {
                    if($data['branch_id'] == $i['id'])
                    {
                      $selected = ' selected';
                    }
                  }
                ?>
                  <option value="<?=$i['id']?>" <?=$selected?>><?=$i['region']?></option>
          ...
          <div >
              <a href="javascript:;" onclick="history.back()" class="btn btn-default btn-sm"><i class="fa fa-arrow-left"></i> Back</a>
