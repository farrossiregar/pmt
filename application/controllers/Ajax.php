...
class Ajax extends CI_Controller {
	...
	public function getMaterial()
	{
		...
		if($id)
		{
			$material =  $this->db->get_where('material', ['material_group' => $id])->result_array();
			$html = '<option value="">Pilih Material</option>';
	...
	public function getprojectcode()
	{
		...
		$this->db->like('code', $post['name']);
		$data = $this->db->get('project_code')->result_object();
	...
	public function getregioncode()
	{
		...
		$this->db->like('region_code', $post['name']);
		$data = $this->db->get('region')->result_object();
		...
		if($data)
		{
			...
			{
				$params[$key]['id'] 		= $item->id;
				$params[$key]['value'] 		= $item->region_code; 
			}
		}
